...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('contact/' .$contacts->id) }}" method="post">
        ...
        <input type="text" name="profile" id="address" value="{{$contacts->address}}" class="form-control"></br>
        <label>Password</label></br>
        <input type="text" name="password" id="mobile" value="{{$contacts->mobile}}" class="form-control"></br>
